...
class FeedingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ui.btnBackFeed.setOnClickListener {
...
//        }
        ...
        val rdType = ui.radioGroupType
        val rdSide = ui.radioGroupSide
        ui.btnSave.setOnClickListener {
            ...
            val selectRdSide :Int = rdSide!!.checkedRadioButtonId
            val rdSideVal = findViewById<RadioButton>(selectRdSide)
            val SideVal = if(rdSideVal != null) rdSideVal.text.toString() else ""
            //Toast.makeText(this, rdSideVal.text, Toast.LENGTH_SHORT).show();
            ...
            val btCount = ui.editBottleCount.text.toString()
            ...
            {
                Toast.makeText(this, "Please check the side", Toast.LENGTH_SHORT).show();
            }
            else if(editDate == "")
            {
                ...
                database = FirebaseDatabase.getInstance().getReference("FeedingRecords")

                val feedingRecords = Feeding(
                    id = myUuidAsString,
                    type = TypeVal,
                    side = SideVal,
                    date = editDate,
                ...
                database.child(myUuidAsString).setValue(feedingRecords).addOnSuccessListener {

                    ui.radioGroupType.clearCheck()
                    ui.radioGroupSide.clearCheck()
                    ui.editDate.text.clear()
                    ui.editStartTime.text.clear()
                    ui.editEndTime.text.clear()
                    ui.editBottleCount.text.clear()
